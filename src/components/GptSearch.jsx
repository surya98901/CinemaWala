...
const GptSearch = () => {
    ...
    return (
        <div className="flex flex-col gap-4 ">
            <div className="w-14/15 m-auto mt-30">
                  <div
                  ...
                  <div className=" absolute w-14/15 h-150 bg-gradient-to-b from-black to-red-950 p-0 opacity-70 rounded-b-2xl"></div>
                  <div className=" relative w-full h-150 flex flex-col justify-center items-center  ">
                    ...
                    onSubmit={(e) => e.preventDefault()}>
                      <input
                        ...
                        className="w-5/9 h-15 p-4 m-4 rounded-2xl bg-white text-black text-2xl font-bold  mx-4"/>
                      <button className="w-1/9 h-15 p-4 m-4 rounded-2xl bg-red-600 text-white text-2xl font-bold  mx-4">
                        Get Started
                      </button>
                    </form>
                  </div>
